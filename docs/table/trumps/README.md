...
Full trump canon branch for `ProcessCards`.

Это не short prototype law branch.
Это не runtime-complete engine branch.
Это не финальный balance document.

Эта папка хранит полный набор trump-event docs
как table-level canon branch.

Источник truth для текущего trump набора:

```text
docs/table/TRUMP_IDENTITY_LAW.md
```
...
full trump canon branch.
adopt into short laws before runtime.
